...
تطبيق محادثة ذكي يسمح للمستخدمين بالتفاعل مع عدة موفري ذكاء اصطناعي (OpenAI, Groq, Hugging Face) عبر واجهة حديثة وجميلة.

### ✨ المميزات الرئيسية

- 💬 **دعم موفري متعددين** - التبديل السلس بين نماذج مختلفة
- 📁 **إدارة المحادثات** - إنشاء وتنظيم وإدارة محادثات متعددة
- 💾 **حفظ دائم** - جميع المحادثات تُحفظ تلقائياً في ملف JSON
- 🏷️ **تسمية تلقائية** - عناوين المحادثات تُولد من أول رسالة
- 📱 **تصميم متجاوب** - يعمل بشكل رائع على جميع الأجهزة
- 🎨 **واجهة حديثة** - تصميم نظيف وسهل الاستخدام
- ⚡ **تحديثات فورية** - عرض الرسائل فوراً مع مؤشرات التحميل
- 🔄 **التحكم في المحادثات** - تعديل وحذف وإعادة توليد الرسائل
...
|-----------|---------|-------|
| **ASP.NET Core** | 10.0 | إطار العمل وقاعدة التشغيل |
| **C#** | 12.0 | لغة البرمجة الأساسية |
| **.NET CLI** | الأحدث | بناء وتشغيل المشروع |
| **نمط MVC** | - | معمارية التطبيق |

#### الواجهة (Frontend)
| التكنولوجيا | الإصدار | الغرض |
|-----------|---------|-------|
| **HTML5** | - | البنية والترميز |
| **CSS3** | - | التنسيق والرسومات |
| **JavaScript** | ES6+ | التفاعل والوظائف |
| **Razor Pages** | - | العرض الديناميكي |

#### التكاملات والذكاء الاصطناعي
| الخدمة | الغرض | النموذج |
|-------|-------|--------|
| **OpenAI** | المزود الأساسي | gpt-4o-mini |
| **Groq** | الاستدلال السريع | llama-3.3-70b |
| **Hugging Face** | موفر بديل | Phi-3-mini |

#### التخزين والبيانات
| التكنولوجيا | الغرض |
|-----------|-------|
| **JSON** | حفظ المحادثات والإعدادات |
| **نظام الملفات** | تخزين البيانات المحلي |

#### أدوات التطوير
| الأداة | الإصدار | الغرض |
|------|--------|-------|
| **Visual Studio Code** | الأحدث | محرر الأكواد |
| **Git** | 2.x | التحكم بالإصدارات |
| **NuGet** | الأحدث | مدير الحزم |
| **OpenAI SDK** | الأحدث | مكتبة OpenAI الرسمية |

### 🚀 البدء السريع

#### المتطلبات
- .NET 10.0 SDK أو أحدث
- مفاتيح API من OpenAI أو Groq أو Hugging Face
...
2. **تكوين مفاتيح API**
أنشئ ملف `ChatGPTClone/apiconfig.json`
...
6. **الوصول للتطبيق**
انتقل إلى `http://localhost:5292`

### 📖 كيفية الاستخدام

#### إنشاء محادثة جديدة
1. اضغط على زر **"New Chat"** في الشريط الجانبي
2. ابدأ بكتابة رسالتك الأولى
3. سيتم توليد عنوان المحادثة تلقائياً
4. اضغط **Send** أو Enter

#### إدارة المحادثات
- **عرض المحادثات الأخيرة** - جميع محادثاتك تظهر في قسم Recents
- **التبديل بين المحادثات** - اضغط على أي محادثة لتحميلها
- **حذف السجل** - اضغط على زر النقاط الثلاث واختر "Clear History"

### 💾 حفظ البيانات

تُحفظ جميع المحادثات تلقائياً في `chats.json`:
- معرف فريد لكل محادثة
- عنوان مولد من أول رسالة
- تاريخ الإنشاء
- جميع الرسائل بين المستخدم والذكاء الاصطناعي

### 🔐 الأمان

- ⚠️ **مفاتيح API** - لا تحفظها في Git (مضافة إلى `.gitignore`)
- 🔒 **تحقق من الإدخال** - تنظيف جميع المدخلات
- 🛡️ **معالجة الأخطاء** - معالجة شاملة للأخطاء

### 🎨 التصميم والتجربة

- **واجهة داكنة** - مريحة للعين للاستخدام المطول
- **أزرار بتدرجات** - تغذية راجعة بصرية حديثة
- **تخطيط متجاوب** - شريط جانبي وحاوية المحادثات الرئيسية
- **رسائل ملونة** - أخضر للمستخدم، رمادي للذكاء الاصطناعي

### 📝 ملاحظات مهمة

- سجل المحادثات يظل محفوظاً حتى بعد إغلاق المتصفح
- عناوين المحادثات تُولد من أول 35 حرف من الرسالة الأولى
- يمكنك اختبار موفري ذكاء اصطناعي مختلفين من القائمة المنسدلة
- جميع الرسائل تُعرض فوراً
